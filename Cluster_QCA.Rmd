...
CLUSTERPANELB<-c(House, solb)
CLUSTERPANELB<-as.data.frame(CLUSTERPANELB)
```
...
wicons=TRUE)
PANELA
PANELB <-cluster(data = CLUSTERPANEL, results= "SAFE*TERM*NON_CIT", outcome = "POLAR",unit_id =
"STATE", cluster_id = "YEAR", necessity=FALSE,
wicons=TRUE)
PANELB
```
...
labbb = c("VA_2010","OR_2010","TX_2010","UT_2010","VA_2014","OR_2014","TX_2014","VA_2016","OR_2016","VA_2012","OR_2012","TX_2012","UT_2012","UT_2014","TX_2016","UT_2016")

labb = c("CA_2010","CO_2010","FL_2010","CA_2012","NV_2012","CA_2014","CA_2016","FL_2016","NV_2016")
...
data = CLUSTERPANEL, necessity = FALSE, jitter = TRUE, fontsize = 3,  ylab = "POLAR", xlab = "UNL_DON*MIGR", main = "", labs = CLUSTERPANEL$rrow2)

p2 = xy.plot(x = "SAFE.TERM.NON_CIT", y = "POLAR" ,
data = CLUSTERPANEL, necessity = FALSE, jitter = TRUE, fontsize = 3,  ylab = "POLAR", xlab = "COMPET*TERM*MIGR", main = "", labs = CLUSTERPANEL$rrow3)
